-- Qualify service columns in booking functions.
-- The original functions used `where id = p_service_id`; in the PL/pgSQL
-- hold function that name conflicts with the returned `id` column.
